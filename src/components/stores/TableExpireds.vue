        ...
        <v-data-table
          ...
          <template v-slot:top>
            <v-toolbar flat class="mt-2">
              <v-toolbar-title>
                جدول تاريخ الصلاحية لمواد المخزن
              </v-toolbar-title>
...
<script>
  ...
  export default {
    ...
    computed: {
      store_expired_query: {
        set(val) {
          this.$store.state.stores.store_expired_query = val;
        },
        get() {
          return this.$store.state.stores.store_expired_query;
        },
      },
      pageCount() {
        return this.$store.state.stores.pageCount3;
      },

      expired_stores() {
        return this.$store.state.stores.expired_stores;
      },
      loading() {
      ...
      params: {
        set(val) {
          this.$store.state.stores.params_expired = val;
        },
        get() {
          return this.$store.state.stores.params_expired;
        },
      },
    },
    methods: {
      ...
      get_stores() {
        ...
        this.params = par;
        this.$store.dispatch("stores/get_stores_expired");
      },
      query_change() {

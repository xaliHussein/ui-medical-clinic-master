            ...
            <v-card-text class="mt-7">
              <v-row>
                <v-col cols="12" sm="6" md="4" lg="4">
                  <Input
                    @update-value="medicen_name = $event"
                    :value="medicen_name"
                    type="text"
                    label="اسم دواء"
                    :rules="RulseAll" />
                ...
                <v-col cols="12" sm="6" md="4" lg="4">
                  <Textarea
                    @update-value="side_effect = $event"
                    :value="side_effect"
                    type="text"
                ...
                <v-col cols="12" sm="6" md="4" lg="4">
                  <InputDate
                    ...
                    :value="date"
                    :rules="RulseAll"
                    label=" تاريخ انتهاء صلاحية الدواء" />
                </v-col>
                <v-col cols="12" sm="4">
                  <div
                  ...
                  <h3 class="text-start mt-2 mr-2">اضف صوره الدواء :</h3>
                </v-col>
              </v-row>
            </v-card-text>
...
<script>
  ...
  import Table from "../components/pharmacies/Table.vue";
  ...
  export default {
    ...
    computed: {
      ...
      loading() {
        return this.$store.state.pharmacies.loading_add_medicine;
      },
    },
    methods: {
      add_medicine() {
        if (this.$refs.add_medicine.validate()) {
          let data = {};
          data["medicen_name"] = this.medicen_name;
          ...
          data["side_effect"] = this.side_effect;
          data["representative_id"] = this.representative_id;
          data["image"] = this.upload[0];
          this.$store.dispatch("pharmacies/add_medicine", data).then(() => {
